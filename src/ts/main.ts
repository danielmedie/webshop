...
// //     localStorage.setItem('cart', JSON.stringify(addTolocalStorage)+1)
// //     //document.querySelector("items-preview").innerHTML=JSON.stringify(cart)+1;
// //   }
// //   const addedToCart = (product: Product) => {
// //     let cart = JSON.parse(localStorage.getItem('cart') || '[]')
// //     cart.push(product)
// //     localStorage.setItem('cart', JSON.stringify(cart))
// //     cart.innerHTML("items-preview");
// //   }}
