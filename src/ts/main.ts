...
let painting1 = {
  ...
  description:
    "Eaque, consequuntur a expedita odit vero blanditiis autem explicabo nisi.",
  price: 300,
...
let painting3 = {
  title: "Blommor",
  description:
    "Architecto minus laudantium consequatur quisquam accusantium voluptates hic quas aspernatur consectetur error!",
  price: 300,
...
//   ?.addEventListener("click", purchasedClick);
...
// let cartItems: HTMLDivElement = document.getElementById!(
//   "items-preview"
// ) as HTMLDivElement;
...
//     "new-in__container__desktop"
//   )[0];
//   let cartRows = cartItemsContainer.getElementsByClassName(
//     "new-in__container__desktop__box"
//   );
